...
#define relay1 13 //继电器连接在8266的GPIO2上
const char *ssid     = "TP-LINK_9572";//这里是我的wifi，你使用时修改为你要连接的wifi ssid
const char *password = "15520486193";//你要连接的wifi密码
const char *host = "www.bigiot.net";//修改为手机的的tcpServer服务端的IP地址，即手机在路由器上的ip
WiFiClient client;
const int tcpPort = 8181;//修改为你建立的Server服务端的端口号
   http://www.bigiot.net/User/index.html
